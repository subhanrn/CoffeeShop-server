...
async function discover() {
    ...
    config.Outlet = { dataSource: DATASOURCE_NAME, public: true };
    config.Account = { dataSource: DATASOURCE_NAME, public: true };
    config.Charger = { dataSource: DATASOURCE_NAME, public: true };
    config.Transaksi = { dataSource: DATASOURCE_NAME, public: true };
    config.Callbacks = { dataSource: DATASOURCE_NAME, public: true };
